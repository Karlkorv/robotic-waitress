...
#ifndef RW_INTERFACES__MSG__DETAIL__DETECTIONS__TRAITS_HPP_
#define RW_INTERFACES__MSG__DETAIL__DETECTIONS__TRAITS_HPP_
...
inline void to_yaml(
  const rw_interfaces::msg::Detections & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rw_interfaces::msg::Detections & msg)
{
  return rw_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rw_interfaces::msg::Detections>()
{
  return "rw_interfaces::msg::Detections";
}

template<>
inline const char * name<rw_interfaces::msg::Detections>()
{
  return "rw_interfaces/msg/Detections";
}

template<>
struct has_fixed_size<rw_interfaces::msg::Detections>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rw_interfaces::msg::Detections>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rw_interfaces::msg::Detections>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // RW_INTERFACES__MSG__DETAIL__DETECTIONS__TRAITS_HPP_
