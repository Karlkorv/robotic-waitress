...
{
  new (message_memory) rw_interfaces::msg::Ultrasonic(_init);
}

void Ultrasonic_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rw_interfaces::msg::Ultrasonic *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Ultrasonic_message_member_array[2] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rw_interfaces::msg::Ultrasonic, header),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Ultrasonic_message_members = {
  ...
  2,  // number of fields
  sizeof(rw_interfaces::msg::Ultrasonic),
...
get_message_type_support_handle<rw_interfaces::msg::Ultrasonic>()
{
  return &::rw_interfaces::msg::rosidl_typesupport_introspection_cpp::Ultrasonic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rw_interfaces, msg, Ultrasonic)() {
  return &::rw_interfaces::msg::rosidl_typesupport_introspection_cpp::Ultrasonic_message_type_support_handle;
}
